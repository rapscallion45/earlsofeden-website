...
const Hero: React.FC = () => (
    ...
    >
        <div className="bg-black/40 p-4 lg:p-8 rounded-2xl max-w-xl text-center">
            <h1 className="text-6xl font-heading font-extrabold tracking-tight text-white">
                EARLS OF EDEN
            </h1>
            <p className="mt-4 font-body text-gray-200 font-bold text-xl">
                Debut single "Save Me" out October 31st!
            </p>
            <img
                src="/assets/album_art.webp"
                alt="Logo"
                className="mx-auto mt-10 w-60 lg:w-80 h-auto"
            />
